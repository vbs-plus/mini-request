...
export declare namespace wx {
  ...
  interface RequestOption {
     ...
     *  接口调用成功的回调函数
     */
    success?(result: wx.HttpResponse): void;
  }
...
export declare namespace my {
  ...
  interface RequestOption {
     ...
     *  接口调用结束的回调函数（调用成功、失败都会执行）
     */
    complete?(result: my.HttpResponse): void;
    /**
     *  接口调用失败的回调函数
     */
    fail?(result: my.HttpResponse): void;
    /**
     *  接口调用成功的回调函数
     */
    success?(result: my.HttpResponse): void;
  }
  interface RequestTask {
    /**
